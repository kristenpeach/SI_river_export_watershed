...
KRR_S65 <- delineateWatershed(xlocation = -81.19755, ylocation = 27.80358, crs = 4326, includeparameters = "true", rcode = "FL")

	
KRR_S65_params <- KRR_S65$parameters

KRR_S65_params <- 	KRR_S65_params %>% mutate(Unique_site_id = "KRR_S65")
...
Sites to merge:
NWT_SADDLE_STREAM_params
NWT_MARTINELLI_params
NWT_ALBION_params 
