...
KRR_S65_params <- 	data.frame(ID = "0", name = param_name, description = param_description, code = param_code, unit = param_unit, value = param_value, Unique_site_id = "KRR_S65D")
...
KRR_S65A <- delineateWatershed(xlocation = -81.13427, ylocation = 27.65964, crs = 4326, includeparameters = "true", rcode = "FL")

	
KRR_S65A_params <- KRR_S65A$parameters

KRR_S65A_params <- 	KRR_S65A_params %>% mutate(Unique_site_id = "KRR_S65A")
...
KRR_S65D <- delineateWatershed(xlocation = -81.02285, ylocation = 27.31437, crs = 4326, includeparameters = "true", rcode = "FL")

	
KRR_S65D_params <- KRR_S65D$parameters

KRR_S65D_params <- 	KRR_S65D_params %>% mutate(Unique_site_id = "KRR_S65D")
