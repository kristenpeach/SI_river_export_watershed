...
AND_lat <- AND_only$Latitude
AND_long <- AND_only$Longitude
AND_unique_site_id <- AND_only$Unique_Site_ID

AND_lat <- c(44.22054, 44.21202, 44.26151, 44.26464, 44.26629, 44.20119 ,44.21706)
AND_long <- c(-122.1728, -122.2449, -122.1807, -122.1753, -122.1708, -122.2588, -122.2611)
AND_Unique_site_id <- c("AND_GSMACK", "AND_GSWS02", "AND_GSWS06", "AND_GSWS07", "AND_GSWS08", "AND_GSWS09", "AND_GSWS10")

AND_df <- data.frame(Site = "AND", Longitude = AND_long, Latitude = AND_lat, Unique_Site_ID = AND_Unique_site_id)

AND_only_points <- sf::st_as_sf(AND_df,
                                 coords = c("Longitude", "Latitude"))
