...
summary_metadata <- my_data$summary_metadata
...
ws2 <- delineateWatershed(xlocation = -71.72650, ylocation = 43.95203, crs = 4326,
includeparameters = "true")

params_ws2 <- ws2$parameters

#Cool map!
map_ws2 <- leafletWatershed(ws2)

#Looking at all the available features
features_ws2 <- pullFeatureCollection(ws2)
...
shp_ws2 <- writeShapefile(ws2, layer = "test")
